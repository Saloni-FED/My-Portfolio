...
const Landing = ({ setSelectedPage }) => {
  ...
  return (
    <section
      id="home"
      className="md:flex md:justify-between md:items-center md:h-full gap-16 py-10 relative"
    >
      <div className="flex flex-col-reverse md:flex-row justify-center gap-10 items-center z-10 mt-16 md:mt-32 mx-auto">
